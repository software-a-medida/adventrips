...
class Set_users_permissions_vkye_adm
{
    static public function permissions($key = null)
    {
        $arr = [
            ...
            'Reservations/index' => ['{reservations_read}'],
            'Reservations/view' => ['{reservations_read}'],
            'Reservations/create' => ['{reservations_create}'],
            'Reservations/get_data_ajax' => ['{reservations_create}'],
        ];
